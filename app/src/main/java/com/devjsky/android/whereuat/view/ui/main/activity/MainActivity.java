...
import com.devjsky.android.whereuat.view.ui.tracking.activity.TrackingActivity;
        ...
        naverMap.setOnMapClickListener(new NaverMap.OnMapClickListener() {
            ...
            public void onMapClick(@NonNull PointF pointF, @NonNull LatLng latLng) {
                if (meetingMarker == null) {
                    ...
                    meetingData.setPlaceLatitude(latLng.latitude);
                    meetingData.setPlaceLongitude(latLng.longitude);
                    String address = GpsUtils.getCurrentAddress(mContext, latLng.latitude, latLng.longitude) + "";
                    meetingData.setPlaceAddress(address);
